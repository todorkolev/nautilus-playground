...
"""
Implementation of a Mean Reversion Strategy V2.
"""
...
from src.strategies.mean_reversion.ml_model import LogisticRegressionModel, DecisionTreeModel


class MeanReversionV2Config(StrategyConfig):
    """
    Configuration for the Mean Reversion Strategy V2.
    ...
    @classmethod
    def from_yaml(cls, path: str) -> "MeanReversionV2Config":
        """
        ...
        return cls(
            ...
            ml_model_type=params.get("ml_model_type", "logistic_regression"),
...
class MeanReversionStrategyV2(Strategy):
    """
    A Mean Reversion Strategy V2.
    ...
    Parameters
    ----------
    config : MeanReversionV2Config
        The configuration for the strategy.
    """

    def __init__(self, config: MeanReversionV2Config) -> None:
